export const lyricsAlbum = 'Elv1s 30 #1 Hits';
export const lyricsArtist = 'Elvis Presley';
export const lyricsTitle = 'Jailhouse Rock';
export const lyricsOffset = '500';

export const lyricsTextSingle =
  'The prison band was there and they began to wail.';
export const lyricsTextMultiple = "Let's rock, everybody, let's rock.";
